...
export function useCustomLookControls(aframeConfig) {
  ...
  const componentName = 'custom-look-controls';
  ...
  function handleRegister(newAframe) {
    ...
    const bind = newAframe.utils.bind;

    // To avoid recalculation at every mouse movement tick
    const PI_2 = Math.PI / 2;

    /**
     * custom-look-controls. Update entity pose, factoring mouse, touch, and WebVR API data.
     */
    newAframe.registerComponent(componentName, {
      ...
      init: function () {
        this.deltaYaw = 0;
        this.previousHMDPosition = new newAframe.THREE.Vector3();
        this.hmdQuaternion = new newAframe.THREE.Quaternion();
        this.magicWindowAbsoluteEuler = new newAframe.THREE.Euler();
        this.magicWindowDeltaEuler = new newAframe.THREE.Euler();
        this.position = new newAframe.THREE.Vector3();
        this.magicWindowObject = new newAframe.THREE.Object3D();
        this.rotation = {};
        this.deltaRotation = {};
        this.savedPose = null;
        ...
        this.savedPose = {
          position: new newAframe.THREE.Vector3(),
          rotation: new newAframe.THREE.Euler(),
        };
      ...
      setupMagicWindowControls: function () {
        ...
        if (
          newAframe.utils.device.isMobile() ||
          newAframe.utils.device.isMobileDeviceRequestingDesktopSite()
        ) {
          magicWindowControls = this.magicWindowControls =
            new newAframe.THREE.DeviceOrientationControls(
      ...
      setupMouseControls: function () {
        ...
        this.pitchObject = new newAframe.THREE.Object3D();
        this.yawObject = new newAframe.THREE.Object3D();
      ...
      updateOrientation: function () {
        ...
        object3D.rotation.z = 0 - this.magicWindowDeltaEuler.z;
      },
