...
useHeadMataData({
  title: t('components_page.hero.title'),
  meta: [
    {
      name: 'description',
      content: t('components_page.hero.description')
    }
  ]
});
    ...
    mainEntity: {
      ...
      itemListElement: [
        // UI Components
        {
          '@type': 'ListItem',
          position: 1,
          name: t('components.tab'),
          url: `${DOMAIN}${localePath('/components/tab-test')}`
        },
        {
          '@type': 'ListItem',
          position: 2,
        ...
        // Functional Components
        {
          '@type': 'ListItem',
          position: 9,
          name: t('components.scroll_fetch'),
          url: `${DOMAIN}${localePath('/components/scroll-fetch')}`
        },
        {
          '@type': 'ListItem',
          position: 10,
        ...
        // Third-party Integrations
        {
          '@type': 'ListItem',
          position: 16,
          name: t('components.wang_editor'),
          url: `${DOMAIN}${localePath('/components/wang-editor-test')}`
        },
        {
          '@type': 'ListItem',
          position: 17,
          name: t('components.youtube'),
          url: `${DOMAIN}${localePath('/components/youtube-test')}`
        },
        {
          '@type': 'ListItem',
          position: 18,
...
// Third-party Integrations
const integrationComponents = computed(() => [
  {
...
// Combined Tests
const combinedComponents = computed(() => [
  {
