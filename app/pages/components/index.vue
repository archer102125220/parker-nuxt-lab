...
const functionalComponents = computed(() => [
  { to: localePath('/components/scroll-fetch'), label: t('components.scroll_fetch') },
  ...
  { to: localePath('/components/virtual-scroller'), label: 'Virtual Scroller 組件測試' },
...
const integrationComponents = computed(() => [
  { to: localePath('/components/wang-editor-test'), label: t('components.wang_editor') },
  { to: localePath('/components/youtube-test'), label: t('components.youtube') },
