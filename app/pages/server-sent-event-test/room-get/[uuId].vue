  ...
  <div class="sse_room_get_page">
    ...
    <section class="sse_room_get_page-section">
      ...
      <div class="sse_room_get_page-section-room_info">
        <div class="sse_room_get_page-section-room_info-row">
          <span class="sse_room_get_page-section-room_info-row-label">
            {{ $t('sse_room_get_page.room_id_label') }}
          </span>
          ...
          <v-btn
            ...
            :title="$t('sse_room_get_page.copy_id_title')"
            @click="copyRoomId"
          >
            <v-icon size="16">{{
          ...
          >
            {{ $t('sse_room_get_page.copied') }}
          </span>
        </div>
        <div class="sse_room_get_page-section-room_info-row">
          <span class="sse_room_get_page-section-room_info-row-label">
            {{ $t('sse_room_get_page.share_url_label') }}
          </span>
          <v-btn
            size="small"
            variant="tonal"
          ...
          >
            ...
            {{ copiedUrl ? $t('sse_room_get_page.url_copied') : $t('sse_room_get_page.copy_url') }}
          </v-btn>
        </div>
      </div>

      <!-- Messages -->
      <p class="sse_room_get_page-section-label">
        {{ $t('sse_room_get_page.received_data_label') }}
      </p>
      <div class="sse_room_get_page-section-messages">
        ...
        >
          {{ $t('sse_room_get_page.no_message_yet') }}
        </p>
      </div>
    </section>
  </div>
