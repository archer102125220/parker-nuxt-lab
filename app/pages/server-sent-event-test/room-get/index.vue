<template>
  <div class="sse_room_get_entry_page">
    <!-- Hero Section -->
    <section class="sse_room_get_entry_page-hero">
      <div class="sse_room_get_entry_page-hero-background">
        <div class="sse_room_get_entry_page-hero-background-overlay" />
      </div>

      <div class="sse_room_get_entry_page-hero-content">
        <h1 class="sse_room_get_entry_page-hero-content-title">
          {{ $t('sse_room_get_page.hero.title') }}
        </h1>
        <p class="sse_room_get_entry_page-hero-content-subtitle">
          {{ $t('sse_room_get_page.hero.subtitle') }}
        </p>
        <p class="sse_room_get_entry_page-hero-content-description">
    ...
    <!-- Main Content -->
    <section class="sse_room_get_entry_page-section">
