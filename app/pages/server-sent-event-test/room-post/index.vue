...
const rules = computed(
  () => () =>
    ...
    roomId.value === '' ||
    t('sse_room_post_page.invalid_uuid')
);
      ...
      <div class="sse_room_post_entry_page-section-actions">
        ...
        <div class="sse_room_post_entry_page-section-actions-join">
          <h2 class="sse_room_post_entry_page-section-actions-join-title">
            {{ $t('sse_room_post_page.join_room_title') }}
          </h2>
          <p class="sse_room_post_entry_page-section-actions-join-desc">
            {{ $t('sse_room_post_page.join_room_desc') }}
          </p>
          <v-text-field
            v-model="roomId"
            clearable
            label="Room ID"
            :placeholder="$t('sse_room_post_page.input_placeholder')"
          ...
          <v-btn
            ...
            @click="joinRoom"
          >
            {{ $t('sse_room_post_page.join_room_btn') }}
          </v-btn>
        </div>
      </div>
    </section>
