<template>
  <section class="web_rtc_socket_io_page">
    ...
    <div class="web_rtc_socket_io_page-context">
      <div class="web_rtc_socket_io_page-context-initiate">
        <NuxtLink
          class="web_rtc_socket_io_page-context-initiate-link"
          :to="$localePath('/web-rtc/socket.io/room')"
        >
          <v-btn color="primary" height="116px" block> 建立視訊聊天 </v-btn>
        </NuxtLink>
      </div>
      <div class="web_rtc_socket_io_page-context-join">
        <v-text-field
          clearable
          label="room id"
          class="web_rtc_socket_io_page-context-join-room_id"
          v-model="roomId"
          :rules="[rules]"
        />
        <NuxtLink
          class="web_rtc_socket_io_page-context-join-link"
          :to="$localePath(`/web-rtc/socket.io/room/${roomId}`)"
