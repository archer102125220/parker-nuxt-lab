...
<template>
  <div class="web_rtc_websocket_page">
    <!-- Hero Section -->
    <section class="web_rtc_websocket_page-hero">
      <div class="web_rtc_websocket_page-hero-background">
        <div class="web_rtc_websocket_page-hero-background-overlay" />
      </div>

      <div class="web_rtc_websocket_page-hero-content">
        <h1 class="web_rtc_websocket_page-hero-content-title">
          {{ $t('web_rtc_websocket_page.hero.title') }}
        </h1>
        <p class="web_rtc_websocket_page-hero-content-subtitle">
          {{ $t('web_rtc_websocket_page.hero.subtitle') }}
        </p>
        <p class="web_rtc_websocket_page-hero-content-description">
          {{ $t('web_rtc_websocket_page.hero.description') }}
        </p>
      </div>
    </section>

    <!-- Main Content -->
    <section class="web_rtc_websocket_page-section">
      <p
