...
<template>
  <div class="collabora_doc_page">
    ...
    <!-- Docker 啟動說明 -->
    <v-expansion-panels class="collabora_doc_page-guide" variant="accordion">
      <v-expansion-panel>
        <v-expansion-panel-title class="collabora_doc_page-guide-header">
          <span class="collabora_doc_page-guide-header-icon">ℹ️</span>
          <span class="collabora_doc_page-guide-header-text">
            Docker 啟動與常見問題說明
          </span>
        </v-expansion-panel-title>
        <v-expansion-panel-text class="collabora_doc_page-guide-content">
          <p class="collabora_doc_page-guide-content-desc">
            若在編輯器中看見「Unauthorized Host」錯誤，表示 Collabora
            尚未授權專案的網址存取。請根據您的 Nuxt 執行環境選擇對應的指令啟動
            (Port 為 9980)：
          </p>
          <p class="collabora_doc_page-guide-content-subtitle">
            HTTP 環境 (最單純推薦)
          </p>
          <div class="collabora_doc_page-guide-content-code">
            <span>{{ dockerCommandHttp }}</span>
            <v-btn
              icon="mdi-content-copy"
              variant="text"
              size="small"
              class="collabora_doc_page-guide-content-code-copy"
          ...
          <div class="collabora_doc_page-guide-content-note">
            <p class="collabora_doc_page-guide-content-note-item">
          ...
          <div class="collabora_doc_page-guide-content-troubleshoot">
            <p class="collabora_doc_page-guide-content-troubleshoot-title">
              【常見問題】Mixed Content 混合內容封鎖 (無法建立連線)
            </p>
            <p class="collabora_doc_page-guide-content-troubleshoot-item">
    ...
    <!-- 加入使用者資訊表單 -->
    <div class="collabora_doc_page-auth">
      <div class="collabora_doc_page-auth-title">使用者登入資訊</div>
      <form
        class="collabora_doc_page-auth-form"
        @submit.prevent="generateToken"
      >
        <div class="collabora_doc_page-auth-form-fields">
          <v-text-field
            v-model="userId"
            class="collabora_doc_page-auth-form-fields-input"
            label="User ID"
            variant="outlined"
            required
            hide-details="auto"
        ...
        <v-btn
          class="collabora_doc_page-auth-form-btn"
          color="primary"
          type="submit"
