...
useHeadMataData({
  title: t('univer_sheet_page.title'),
  meta: [
    {
      name: 'description',
      content: t('univer_sheet_page.description')
    }
  ]
});
...
<template>
  <div class="univer_sheet_page">
    <div class="univer_sheet_page-remark">
      <div class="univer_sheet_page-remark-title">
        <span class="univer_sheet_page-remark-title-icon">⚠️</span>
        <span class="univer_sheet_page-remark-title-text">{{ $t('univer_sheet_page.remark.univer_title') }}</span>
      </div>
...
.univer_sheet_page {
  ...
  &-warning {
    @extend .univer_sheet_page-remark;
