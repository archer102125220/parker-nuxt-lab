...
2. All elements MUST be nested under Block root class
3. Do NOT share CSS class names between pages
4. Use Placeholders (`%name`) for static shared styles
5. Use Mixins (`@mixin`) for parameterized styles
